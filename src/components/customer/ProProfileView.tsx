          ...
          <div className="flex items-start gap-5 md:gap-8">
            ...
            {pro.photo ? (
              <img
                src={pro.photo}
                alt={pro.name}
                className="w-24 h-24 md:w-32 md:h-32 rounded-2xl shadow-xl shrink-0 object-cover"
              />
            ) : (
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, #017a7a, #53eb64)",
          ...
          <div className="bg-white rounded-3xl shadow-card overflow-hidden">
            ...
            <div className="flex border-b border-gray-100">
              {[
                ...
                { key: "reviews", label: `Reviews (${pro.reviewCount})` },
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          onClick={() => {
                            setSelectedService(
                              pro.proServices.find(
                                (gs) => gs.service.id === service.id,
                              )?.service ?? null,
                            );
                            setBookingOpen(true);
                          }}
                          className="btn btn-forest btn-sm lg:opacity-0 lg:group-hover:opacity-100 transition-opacity"
                        >
                          Book
                        </button>
                      </div>
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div
                        ...
                        style={{ color: "#D4A853" }}
                      >
                        {"★".repeat(Math.round(pro.avgRating))}
                      </div>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-bold">{pro.totalJobs}</span>
                        </div>
                        <div className="flex justify-between text-sm">
