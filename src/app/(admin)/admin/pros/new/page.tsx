...
export default function AddProPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/admin/pros/list", {
        method: "POST",
      ...
      setError("Failed to create pro. Please try again.");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 lg:p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Add New Pro</h1>
        <p className="mt-1 text-sm text-gray-500">
          Fill in the pro's details. They will receive a WhatsApp welcome
